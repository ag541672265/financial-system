...
<header class="w">
    ...
    <nav>
    	<a href="index.ftl" class="cur">首页</a>
...
<div class="focus" id="focus">
    ...
    <div class="login_box w">
		<div class="login">
        	<div class="title">余盈利</div>
            <div class="nllv">3.752%</div>
            <div class="txt">月盈利率</div>
            <a onclick="shoenlistDiv(this)" pronum="7" class="jiabut">立即申请</a>
            <div class="txt" style="margin-top:20px;color:#333;">汇创点投为您推荐产品</div>
		</div>
	</div>
    
	<div id="focus_m" class="focus_m">
		<ul>
			<li class="li_1" style="background:url(../static/images/1.jpg) center 0 no-repeat #288cc0;"><a href="#" hidefocus="true"></a></li>
			<li class="li_2" style="background:url(../static/images/2.jpg) center 0 no-repeat #76b7d8;"><a href="#" hidefocus="true"></a></li>
			<li class="li_3" style="background:url(../static/images/3.jpg) center 0 no-repeat #bb3838;"><a href="#" hidefocus="true"></a></li>
		</ul>
	</div>
...
<div class="invest-list w">
  ...
  <div class="item">
    	...
    	<div class="pic"><img src="../static/images/pro-1.jpg"></div>
  ...
  <div class="item">
        ...
        <div class="nhl">年化盈利率：<span>2.78%</span></div>
    	<div class="pic"><img src="../static/images/pro-1.jpg"></div>
        <a  onclick="shoenlistDiv(this)" pronum="4" class="joinbut">立即申请</a>
        <div class="title">最新投资理财项目</div>
        <div class="con">
        	<span class="l">筹资金额：</span><em>1788 </em> <span class="l"> 元</span>
            <dl>已完成</dl><span class="r">状态：</span>
  ...
  <div class="item">
        ...
        <div class="nhl">年化盈利率：<span>2.78%</span></div>
    	<div class="pic"><img src="../static/images/pro-1.jpg"></div>
        <a  onclick="shoenlistDiv(this)" pronum="5" class="joinbut">立即申请</a>
        <div class="title">最新投资理财项目</div>
        <div class="con">
        	<span class="l">筹资金额：</span><em>1788 </em> <span class="l"> 元</span>
            <dl>已完成</dl><span class="r">状态：</span>
  ...
  <div class="item">
        ...
        <div class="nhl">年化盈利率：<span>2.78%</span></div>
    	<div class="pic"><img src="../static/images/pro-1.jpg"></div>
        <a onclick="shoenlistDiv(this)" pronum="6" class="joinbut">立即申请</a>
        <div class="title">最新投资理财项目</div>
        <div class="con">
        	<span class="l">筹资金额：</span><em>1788 </em> <span class="l"> 元</span>
            <dl>已完成</dl><span class="r">状态：</span>
...
<footer>
	<div class="fmain w">
    	<div class="fm-top">
            ...
            <div class="right">
            	<div class="ewm"><img src="../static/images/qrc.png"><span>添加我们的微信</span></div>
            	<div class="ewm" style="margin-left:20px;"><img src="../static/images/qrc.png"><span>关注公众号</span></div>
            </div>
        </div>
        <div class="fm-bot">
...
<div class="suspension">
	<div class="suspension-box">
		...
		<div class="d d-qrcode">
			<i class="arrow"></i>
			<div class="inner-box">
				<div class="qrcode-img"><img src="../static/images/side_ewm.jpg" alt="" width="110"></div>
				<p>微信服务号</p>
			</div>
		</div>
