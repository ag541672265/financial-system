...
<div class="invest-list">
    ...
    <div class="classname">直投项目</div>

    <div class="title">
        <div class="h1">项目名称</div>
        <div class="h2">预期年化收益</div>
        <div class="h3">项目期限</div>
        <div class="h4">还款方式</div>
        <div class="h5"></div>
    </div>

    <div class="item">
        <div class="txt h1">&nbsp;阳光智选 | 2018073110</div>
        <div class="txt h2">8.50%</div>
        <div class="txt h3"><em>12</em>个月</div>
        <div class="txt h4">按月付息</div>
        <div class="txt h5"><a onclick="shoenlistDiv(this)" pronum="2" class="but">立即申请</a></div>
    </div>
    ...
    <div class="classname" style="margin-top:15px;">合投项目</div>
    ...
    <div class="item">
        <div class="txt h1">&nbsp;阳光智选 | 2018073110</div>
        <div class="txt h2">$2300000.00</div>
        <div class="txt h3"><em>12</em>个月</div>
        <div class="txt h4">按月付息</div>
        <div class="txt h5"><a onclick="shoenlistDiv(this)" pronum="2" class="but">立即申请</a></div>
    </div>
...
<div class="applyMain" id="applyMain" style="display:none;">
    ...
    <div class="txt" style="margin-top:30px;">您的真实姓名：</div>
    <input type="text" name="cName" required placeholder="请输入您的真实姓名" autocomplete="off" class="input">
    <div class="txt" style="margin-top:15px;">您的身份证号：</div>
    <input type="text" name="cardId" required placeholder="请输入您的身份证号" autocomplete="off" class="input">
    <div class="txt" style="margin-top:15px;">投资金额：</div>
    <input type="text" name="jine" required placeholder="请输入您的投资金额" autocomplete="off" class="input">
